...
*/
  ...
  digitalWrite(enable1, HIGH); //Iniciar en bajo todos los enable del driver
...
void controlManual(){
  ...
  //-------------------------------------------------------------
      ...
      if(digitalRead(switchFase2)&& digitalRead(Fcs_2)&& digitalRead(P_Arriba)){
      ...
      if(digitalRead(switchFase3)&& digitalRead(Fcs_3)&& digitalRead(P_Arriba)){
  ...
  //-------------------------------------------------------------
      ...
      if(digitalRead(switchFase2)&& digitalRead(Fci_2)&& digitalRead(P_Abajo)){
      ...
      if(digitalRead(switchFase3)&& digitalRead(Fci_3)&& digitalRead(P_Abajo)){

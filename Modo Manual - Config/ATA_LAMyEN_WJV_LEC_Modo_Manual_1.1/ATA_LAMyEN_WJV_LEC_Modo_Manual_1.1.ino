...
//-------------------------------------------------------------------
//------MODO MANUAL-----SOLO EN LA VERSION 1.1 DEL ARCHIVO MODO MANUAL  <<------------------
//-------------------------------------------------------------------
//------------------------------T_7
unsigned long previousMillis7 = 0;
const long interval7 = 10 ;
//------------------------------T_8
unsigned long previousMillis8 = 0;
const long interval8 = 10 ;
...
// 1.1 ----->> Se quitaron los delay, se pusieron pausas no bloqueantes, para cada if (por cada sentido de giro)
...
void controlManual() {
  ...
  if (ISRCounterM != ISRCounterMPrev) {
    ...
    if (IsCW == true) {
          ...
          if ((unsigned long)(currentMillis - previousMillis7) >= interval7)  //----T_7
    {
      ...
      if ((unsigned long)(currentMillis - previousMillis8) >= interval8)  //----T_8
    {
